            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Book your workstation easily and efficiently. Find available hot desks based on your cluster.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="grid gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    <span>Select your cluster or use your default assignment</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground">
                      3
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Different clusters for staff organization</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Floors with mapped workstations</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Available hot desks across all floors</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Simple booking process for all staff</p>
                  </CardContent>
                </Card>
              </div>
            </div>
